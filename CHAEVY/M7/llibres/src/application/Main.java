...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			txtTitol.setPromptText("Manuel del pedrolo");
			txtAutor.setPromptText("Cosecha de las patatas");
			txtIsbn.setPromptText("4589632014785");
			txtGenere.setPromptText("Terror");
			txtAnypub.setPromptText("666");
			txtEdicio.setPromptText("47ª edición Tapa blanda");
			txtEditora.setPromptText("Bambino S.L");
			txtIdioma.setPromptText("Italiano");
	...
	//Click amb el ratolí
		private Object clickAceptar(MouseEvent e) {
			...
			System.out.println("Titol: " + book.getTitol() + " " + "Autor: " + book.getAutor() + "\n" +
							   "Genere: " + book.getGenere() + " " + "Any publicacio: " + book.getAnypub() + "\n" +
							   "Idioma: " + book.getIdioma() + " " + "ISBN: " + book.getIsbn() + "\n" +
			 				   "Edició: " + book.getEdicio() + " " + "Editora: " + book.getEditora()	
							  );
			return null;
		}	
